...
const FriendScroll = (props) => {
    ...
    let showMessage = {
        "friend":"You have no friends at this time. If you start logging exercises, you'll start getting recommended leagues on the league page. From there, you can make friends!",
